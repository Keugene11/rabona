...
import { Loader2, UserCheck, UserX, Search, UserPlus, Circle, Users } from 'lucide-react'
import Link from 'next/link'
import type { Profile } from '@/types'
import { PROFILE_PUBLIC_COLUMNS } from '@/lib/profile-select'
import InviteLinkCard from '@/components/InviteLinkCard'

type FoFRow = Pick<Profile, 'id' | 'full_name' | 'username' | 'avatar_url' | 'about_me' | 'hidden_from_directory' | 'last_seen' | 'created_at'> & {
  mutual_count: number
}
